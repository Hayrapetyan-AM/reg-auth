<div class="container mt-5">
  <div class="row align-items-center g-lg-5 py-5">
      <div class="col-lg-7 text-center text-lg-start">
        <h1 class="display-4 fw-bold lh-1 mb-5">Welcome to Sign up page</h1>
        ...
        <p class="text-success"> Already have an account? Sign in <a href="index.php?show=Sign-in" class="text-success"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-key" viewBox="0 0 16 16">
